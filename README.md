...
```
target/llm-pentest-burp-1.5.0.jar
```
...
4. In the dialog that appears:
   - **Extension type**: `Java`
   - **Extension file**: click **Select file…** and navigate to `target/llm-pentest-burp-1.5.0.jar`
5. Click **Next**.
6. Watch the **Output** pane — you should see:
   ```
   ✓ LLM PenTest Assistant v1.5.0 loaded
